...
import 'kleur/colors';
import { a as $$Button, $ as $$Icon, t as texts, b as $$Layout } from '../chunks/Layout_BYpjHEww.mjs';
...
const $$Hero = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<section class="bg-center bg-no-repeat bg-cover bg-[url('/assets/img/senior_couple__in_the_park.webp')] bg-blend-multiply"> <div class="px-4 mx-auto max-w-screen-xl text-center lg:text-left py-16 sm:py-24 lg:py-48 flex flex-col lg:flex-row lg:items-center"> <div class="lg:w-1/2 w-full px-4"> <h3 class="text-deep-blue text-ag-sub-heading font-ag-sub-heading mb-2 sm:mb-4">${subtitle}</h3> <h1 class="text-deep-blue mb-4 text-ag-h2 font-ag-h2 tracking-tight leading-tight sm:text-ag-h2 sm:leading-tight"> ${title} </h1> <p class="text-deep-blue mb-8 text-ag-body-text font-ag-body-text sm:text-lg lg:text-xl"> ${description} </p> <div class="flex flex-col space-y-4 sm:flex-row sm:justify-center lg:justify-start sm:space-y-0"> ${renderComponent($$result, "Button", $$Button, { "variant": "primary", "size": "medium", "class": "mx-auto sm:mx-0" }, { "default": ($$result2) => renderTemplate`${buttonText}` })} </div> </div> <!-- Parte derecha vacía para pantallas grandes --> <div class="hidden lg:block lg:w-1/2"></div> </div> </section>`;
}, "E:/Lim/Developer/Projects/seniorCare/src/components/home/Hero.astro", void 0);
...
}, "E:/Lim/Developer/Projects/seniorCare/src/components/common/ImageCarrousel.astro", void 0);
...
}, "E:/Lim/Developer/Projects/seniorCare/src/components/common/ImageCarrousel_2.astro", void 0);
...
}, "E:/Lim/Developer/Projects/seniorCare/src/components/home/FormSection.astro", void 0);
...
}, "E:/Lim/Developer/Projects/seniorCare/src/pages/index.astro", void 0);

const $$file = "E:/Lim/Developer/Projects/seniorCare/src/pages/index.astro";
const $$url = "";
