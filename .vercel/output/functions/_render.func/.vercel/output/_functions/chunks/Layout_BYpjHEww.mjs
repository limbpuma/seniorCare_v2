import { c as createComponent, r as renderTemplate, a as addAttribute, g as renderHead, d as createAstro, m as maybeRenderHead, s as spreadAttributes, e as renderSlot, b as renderComponent } from './astro/server_C5pmyh21.mjs';
import 'kleur/colors';
import 'clsx';
...
const $$Button = createComponent(($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Button;
  const { href, class: className, variant = "primary", size = "medium", fullWidth = false, flex, ...props } = Astro2.props;
...
const $$Icon = createComponent(($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Icon;
  const { icons = [], size = "medium", customSize, variant = "default" } = Astro2.props;
  const sizes = {
    tiny: "text-xs",
    small: "text-sm",
    medium: "text-base",
  ...
  const variantClasses = {
    ...
    light: "text-[#ffffff] hover:text-[#F2B98A]",
...
const $$Footer = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<footer class="bg-deep-blue mx-auto px-4"> <div class="container mx-auto p-4 py-6 lg:py-8"> <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8"> <div class="footer-top mb-6 md:mb-0"> <a href="/" class="flex justify-center md:justify-start items-center mb-4"> ${renderComponent($$result, "Logo", $$Logo, { "class": "h-12 max-w-fit", "color": "white" })} </a> <p class="text-white font-ag-body-text text-ag-body-text mb-4 text-center md:text-left lg:w-11/12"> ${footerTexts.slogan} </p> <div class="flex justify-center md:justify-start space-x-2 text-soft-orange"> ${renderComponent($$result, "Icon", $$Icon, { "icons": [
    ...
    const link = Legallinks.find((l) => l.name.toLowerCase() === linkName.toLowerCase());
